...
\begin{table}[t]
  ...
  \begin{tabular}{rccccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Mean cosine between per-domain and global directions, layers
  0--17 (Qwen~2.5~3B); continued in Table~\ref{tab:layerwise-b}.
...
\begin{table}[t]
  ...
  \begin{tabular}{rccccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Layer-wise mean cosine, layers 18--35 (continued from
