...
\begin{figure}[t]
  \centering
  \includegraphics[width=\columnwidth]{figures/fig_honesty_pca.pdf}
  \caption{PCA projection of per-domain and global honesty directions
  across layers. Domain directions occupy visibly distinct regions rather
  than collapsing onto a single axis.}
  \label{fig:honesty-pca}
\end{figure}

Honesty behaves differently
(Figures~\ref{fig:honesty-heatmap} and~\ref{fig:honesty-pca}). The mean
cosine to the global direction falls
