...
% Non-floating so the two halves stay in reading order and fill column 1
% then column 2 of this page. \newpage in two-column mode breaks to the next
% column, so the second half starts at the top of column 2.
\par\medskip
{\centering
  \small
