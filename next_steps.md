...
- [x] **refusal/privacy harmful prompts topped up** — +80 hand-written harmful privacy requests (`data/harmful_prompts_supplement.jsonl`) so the **prompt-based** refusal privacy domain balances to 100 (was the cap limiter at 29).
